 ...
 */
var potholesDataSet = Class.extend({
    ...
    appendTimeStamp: function(timeFrame,requiredQuery){
        var frequency;
        if(timeFrame === 'lastWeek'){
            frequency = d3.time.day.offset(new Date(), -7);
        }
        else if(timeFrame === 'lastMonth'){
            var lastMonth = d3.time.day.offset(new Date(), -30);
        }
    ...
    getUpdatedData: function(requiredColumns,filterConditions) {
    ...
    generateQuery:function(requiredColumns,filterConditions){
    ...
    startCompare: function(objectA,objectB){
