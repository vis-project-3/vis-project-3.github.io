/**
 * Created by theja on 11/16/14.
 */
function foodInspectionDataSet(){
    //constructor code goes here
    var self = this;
    this.dataSetEndPoint = 'https://data.cityofchicago.org/resource/4ijn-s7e5.json?$$app_token=pJ4wo2exY0EaCEJ758bK7Q5E3';
    this.foodInspectionResultsJSON;
    this.previousfoodInspectionResultsJSON;
    ...
    this.getData = function(requiredColumns,filterConditions,callBack){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                self.foodInspectionResultsJSON = newData;
                self.previousfoodInspectionResultsJSON = newData;
                callBack(newData);
            }
        });
    }
    ...
    this.getUpdatedData = function(requiredColumns,filterConditions,callBack){
        ...
        $.ajax({
            ...
            success: function(data){
                var newData = self.filterData(requiredColumns,data);
                self.foodInspectionResultsJSON = newData;
                var previousData = self.previousfoodInspectionResultsJSON;
                self.previousfoodInspectionResultsJSON = newData;
                self.nullifyChanges();
    ...
    this.appendTimeStamp = function(timeFrame,requiredQuery){
        ...
        requiredQuery += "inspection_date >= \'"+ iso + '\' AND ' ;
    ...
    this.generateQuery = function(requiredColumns,filterConditions){
        ...
        return requiredQuery+'&$order=inspection_date DESC';
    }
